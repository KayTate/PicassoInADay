...
def draw():
    ...
    if page == "Bee":
        if not beeAlreadyDrawn:
            background(255)
            bee()
            finishedButton()
            nextPage()
            savePicture(255,255,255)
            beeAlreadyDrawn = True
        if mousePressed and mouseX > 100 and mouseX < 695 and mouseY > 5 and mouseY < 540 and pmouseX > 100 and pmouseX < 695 and pmouseY > 5 and pmouseY < 540:
            line(pmouseX, pmouseY, mouseX, mouseY) 
...
def mouseClicked():
    global page, iceCreamAlreadyDrawn, penguinAlreadyDrawn, lollipopAlreadyDrawn, rainbowAlreadyDrawn, houseAlreadyDrawn, ladybugAlreadyDrawn, snowmanAlreadyDrawn, robotAlreadyDrawn, beeAlreadyDrawn
    if iceCreamAlreadyDrawn and penguinAlreadyDrawn and lollipopAlreadyDrawn and rainbowAlreadyDrawn and houseAlreadyDrawn and ladybugAlreadyDrawn and snowmanAlreadyDrawn and robotAlreadyDrawn and beeAlreadyDrawn:
        page = "Finished"
        ...
        page = "Bee"
    elif page == "Bee" and mouseX > 560 and mouseX < 610 and mouseY > 20 and mouseY < 70:
        page = "Penguin"
